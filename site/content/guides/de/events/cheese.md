...
- Ein **R4 oder R5 legt den Start** über den einheitlichen Event-Zeitplan fest. Ab diesem Klick hat die Allianz **etwa 1,5 Stunden Zeit zum Angreifen**.
...
| Pfad | Basiert auf | Belohnungen |
|---|---|---|
| Persönlich | Dein eigener Schaden | 5 Phasen mit steigenden Belohnungen |
| Allianz | Allianz-Gesamtschaden | Allianzweite Belohnungsstufen |

Das Zusammenspiel zwischen den Pfaden ist der wichtige Teil:
...
Die Entscheidung für das Level folgt einer klaren Regel:

> Phase 4 der Ratte des nächsthöheren Levels ist geringfügig besser als Phase 5 des vorherigen Levels – und zahlt insgesamt bessere Belohnungen aus.

In der Praxis:

- Etablierte Allianzen laufen **Level 7 oder 8**.
- **Kurz vor einem KvK-Tag, wähle Level 7** – du möchtest Truppen für den [Krieg](/de/events/kvk/) am Leben erhalten, und die marginale Belohnung von Level 8 ist die zusätzlichen Verluste nicht wert.

Bevor du dich festlegst, **überprüfe die Ranglisten**: Zähle die Spieler, die Phase 5 bei der Level-6-Ratte erreichen, gegenüber den Spielern, die Phase 4+ bei Level 7 erreichen. Wenn mehr Spieler aus deinem Kader P4 auf 7 schaffen als P5 auf 6, ist die höhere Ratte die bessere Wahl.

### Die In-Game-Belohnungstabelle lesen {#rewards-table}

Die vollständige Belohnungstabelle findest du im Spiel: **Spezial-Event > Tab Käsefalle > Geschenk-Button > Belohnungen**. Lies sie, bevor die Ratte öffnet – der Phasen-Vergleich zeigt dir genau, wo der Stopp-Punkt deines Kaders liegt.

## Team-Zusammenstellung {#team-setup}

Trupp-Prioritäten für einen langen Bosskampf:

- **Überlebensfähigkeit + anhaltender DPS + Synergie.** Die Ratte ist ein Marathon, kein Sprint-Check.
- **Robuste Frontlinie** — Helden, die den gesamten Kampf über stehen bleiben.
- **Starke Backline** — der Schadensmotor hinter der Frontlinie.
- **Support-Heiler** — hält die Frontlinie am Leben, was die Backline schützt und den Schaden fließen lässt.

Spezifische Helden-Auswahlen und Fraktions-Synergien findest du im [Helden-Guide](/de/heroes/).
