---
title: "Louis: habilidades, build e evolução"
...
<img src="/hero-art/louis.webp" alt="hero art" class="float-right ml-3 mb-3 rounded-xl w-28 sm:w-56" width="220" />
...
| Unlocks on the server | from server day 63 |
...
Swings the iron chain, dealing 87.15% ATK Physical DMG to a single target.
...
Simultaneously swings 2 chains forward, dealing 299.25% ATK damage to enemies within range, healing self for 150% ATK, and reducing all damage taken by 15.38% for 5s.
...
|---|---|
| no stars | - |
| ★10 | Damage reduction additionally applies to 1 nearest ally. |
| ★30 | Damage reduction applies to all allies. |
| ★50 | Deals 60% extra damage. |
| ★50 | Damage reduction increases by 5% |

Value growth by skill level

| Stars | Skill level 1 | Skill level 5 | Skill level 10 | Skill level 40 |
|---|---|---|---|---|
| no stars | 299.25% / 15.38% | 356.25% / 16.88% | 427.5% / 18.75% | 855% / 30% |
...
Charges both hands, creating an energy field that reduces Energy DMG taken by the 2 allies with the highest DEF within range by 9.22% for 4s
...
|---|---|
| no stars | - |
| ★15 | Effect increases by 8%. |
| ★35 | Effect increases by 12%. |
| ★45 | Target +1 |
| ★45 | Target +1 |
...
In combat, reduces all damage taken by 15.38% and triggers an undying state upon taking fatal damage, retaining 1 HP for 2s. The state can only be triggered once.
...
Shackles · damage multiplier · rank 2 of 11
...
Cross Whip · damage multiplier · rank 7 of 9
...
Cross Whip · damage taken reduction · rank 7 of 15
...
Force Link · damage taken reduction · rank 3 of 15
...
Indomitable Spirit · damage taken reduction · rank 8 of 15
...
| Condition | Unlocks |
|---|---|
| from the start | Shackles |
| hero level 5 | Cross Whip |
| hero level 10 | Force Link |
| hero level 20 | Indomitable Spirit |
| ★5 | Shackles: Deals 40% extra damage. |
| ★10 | Cross Whip: Damage reduction additionally applies to 1 nearest ally. |
| ★15 | Force Link: Effect increases by 8%. |
| ★20 | Indomitable Spirit: Duration +1s |
| ★25 | Shackles: Extra damage increases to 100%. |
| ★30 | Cross Whip: Damage reduction applies to all allies. |
| ★35 | Force Link: Effect increases by 12%. |
| hero level 30, ★40 | Tenacity |
| ★45 | Force Link: Target +1 |
| ★45 | Force Link: Target +1 |
| ★45 | Indomitable Spirit: Duration +1s |
| ★50 | Shackles: Extra damage increases to 200%. |
| ★50 | Shackles: Extra damage increases to 300%. |
| ★50 | Cross Whip: Deals 60% extra damage. |
| ★50 | Cross Whip: Damage reduction increases by 5% |
| ★50 | Indomitable Spirit: Duration +1s |
| ★50 | Indomitable Spirit: Duration +1s |
