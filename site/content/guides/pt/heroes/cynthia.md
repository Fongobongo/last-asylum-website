---
title: "Cynthia: habilidades, build e evolução"
...
<img src="/hero-art/cynthia.webp" alt="hero art" class="float-right ml-3 mb-3 rounded-xl w-28 sm:w-56" width="220" />

![icon](/hero-icons/cynthia.webp)

**Nome oficial:** Cynthia
>
...
| Unlocks on the server | from server day 7 |
...
Role: A ranger DPS who spreads her damage across several targets at once and lives on critical hits. Lunar Hunt seizes three random targets for 1,800% of ATK each, while the ultimate Moonfall Dance covers an area for 2,976% and raises her critical hit chance, which the passive Moon's Blessing raises again.

Worth investing: Cynthia ranks third of sixteen DPS heroes by maximum Might (916,153) and sits in tier A. She opens up as early as server day 7, and her 99 guaranteed free shards are more than any UR hero except Marlena, which makes her the realistic second UR for a player who buys nothing. She is worth levelling as soon as she is obtained.
...
Uses a moon blade to deal 87.15% ATK Energy DMG to a single enemy.
...
Increases Crit Rate by 8.2%. Fires a giant moon blade, dealing 520.8% ATK Energy DMG to enemies in range.
...
| ★30 | Deals damage to all enemies. |
| ★50 | Extra damage increases to 100%. |
| ★50 | - |
...
| Stars | Skill level 1 | Skill level 5 | Skill level 10 | Skill level 40 |
|---|---|---|---|---|
| no stars | 8.2% / 520.8% | 9% / 620% | 10% / 744% | 16% / 1,488% |
...
Randomly locks onto 3 targets, launching 3 moon blades, each dealing 210% ATK Energy DMG.
...
Below, Cynthia is compared with the other heroes of the same role, of which the game has 16 in total. Skill numbers are taken at the final star threshold and the maximum skill level.
...
Lunar Hunt · damage multiplier · rank 4 of 15
...
| ★50 | Moon's Blessing: Effect increases by 4%. |
| ★50 | Moon's Blessing: |
...
Reaching 50 stars takes 975 shards ( Cynthia Shard). Besides stats, stars unlock stronger versions of the skills, which makes them matter more than levels:
...
40 levels, 2,870 awakening shards in total ( Cynthia Awaken Shard). At max it adds:
