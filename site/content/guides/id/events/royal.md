...
- **Menara TIDAK aktif** dalam Scramble — itu adalah mekanisme khusus [KvK](/id/events/kvk/). Tidak ada layar menara untuk dilawan di sini.
- **Teleport ke area lumpur (mud)** jika Anda tidak khawatir diserang — **tidak perlu perisai** di sana. Area lumpur adalah tempat persiapan yang aman; gunakanlah.

## Perebutan dan Bala Bantuan {#capture-and-reinforcement}

- **4 jam untuk merebut kastil.** Pendudukan akan terus bertambah selama durasi tersebut — persentase akan terisi **lebih cepat dengan persentase pendudukan yang tinggi** dan **lebih lambat saat diperebutkan** oleh pihak bertahan yang melawan balik.
- **Batas bala bantuan: 30 orang** di kastil. Itu adalah batas maksimal — rencanakan daftar bala bantuan sebelum pertarungan, bukan saat sedang berlangsung.
- **Bala bantuan akan melemah.** Pihak bertahan akan menguras garnisun Anda — **tarik keluar dan kirim bala bantuan kembali** untuk mengatur ulang kondisi. Bala bantuan dengan HP 20% tidak lebih berharga daripada pasukan segar di slot tersebut.
...
- **Hanya R5** — pemimpin aliansi mengklaim dengan **mengeklik kastil setelah pertempuran**.
- **Kelayakan: berada di kerajaan selama lebih dari 24 jam.** Pemain yang pindah ke kerajaan kurang dari sehari sebelum pertarungan tidak dihitung untuk mendapatkan peti.

## Gelar Royal City {#royal-titles}

Memenangkan kastil akan membuka sistem gelar kerajaan — buff persentase berdurasi yang diterapkan oleh pemegang gelar:

| Gelar | Tipe Buff |
|---|---|
| Kecepatan Riset | Buff % berdurasi untuk riset |
| Pengembangan Wilayah | Buff % berdurasi untuk wilayah |
| Pelatihan | Buff % berdurasi untuk pelatihan pasukan |
| Penyembuhan | Buff % berdurasi untuk penyembuhan |
| Menteri Inner Court | Buff produksi pertanian |

Mekanisme antrean:

- **Sistem antrean** — pemain mengantre per slot gelar, siapa cepat dia dapat.
- **Setiap slot berlangsung 5 menit.**
- **Surat tiba di awal dan akhir** slot Anda, sehingga Anda tahu persis kapan buff Anda dimulai dan berakhir.
