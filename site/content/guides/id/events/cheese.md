...
## Dua Jalur Hadiah {#two-reward-tracks}

| Jalur | Berdasarkan | Hadiah |
|---|---|---|
| Pribadi | Damage Anda sendiri | 5 fase hadiah yang meningkat |
| Aliansi | Total damage aliansi | Tingkat hadiah seluruh aliansi |

Interaksi antara kedua jalur ini adalah bagian yang penting:
...
- **Setiap pasukan memberikan damage.** Pool HP tikus sangat besar, dan tidak ada satu pemain kuat pun yang bisa "menghabiskannya" sendirian — satu barisan penuh pasukan murah memberikan damage lebih besar daripada setengah barisan pasukan mahal. Bawa pasukan dalam jumlah banyak, bukan hanya unit elit.

## Penskalaan Level: Tikus Mana yang Harus Dilawan {#level-scaling}

Keputusan level memiliki aturan yang jelas:

> Fase 4 dari tikus level berikutnya sedikit lebih baik daripada Fase 5 dari level sebelumnya — dan memberikan total hadiah yang lebih baik.

Dalam praktiknya:

- Aliansi yang sudah mapan menjalankan **level 7 atau 8**.
- **Mendekati hari KvK, pilih level 7** — Anda ingin pasukan tetap hidup untuk [perang](/id/events/kvk/), dan hadiah tambahan dari level 8 tidak sebanding dengan kerugian pasukan yang lebih besar.

Sebelum memutuskan, **periksa peringkat**: hitung pemain yang mencapai Fase 5 pada tikus level 6 dibandingkan dengan pemain yang mencapai Fase 4+ pada level 7. Jika lebih banyak anggota roster Anda yang bisa menyelesaikan P4 di level 7 daripada P5 di level 6, maka tikus yang lebih tinggi adalah pilihan yang lebih baik.
...
Prioritas pasukan untuk pertarungan bos yang panjang:

- **Survivability + DPS berkelanjutan + sinergi.** Tikus ini adalah maraton, bukan tes burst damage.
- **Garis depan yang tangguh (Tanky frontline)** — hero yang bertahan selama pertarungan berlangsung.
- **Garis belakang yang kuat (Strong backline)** — mesin penghasil damage di belakang garis depan.
- **Support-healer** — menjaga garis depan tetap hidup, yang menjaga garis belakang tetap aman, yang menjaga damage tetap mengalir.

Pilihan hero spesifik dan sinergi faksi ada di [panduan Hero](/id/heroes/).

## Opsi Whale-Carry {#whale-carry}

Jika aliansi Anda memiliki satu pemain yang sangat kuat (whale), ada pola endgame yang efisien: **2-3 rally sudah cukup untuk memaksimalkan hadiah aliansi** saat whale tersebut menanggung beban damage. Semua orang bergabung dengan rally untuk mendapatkan +2,5%, memasukkan pasukan mereka, dan berhenti di Fase 5 pribadi masing-masing. Damage dari whale tersebut mengisi pool bersama; tingkat aliansi terpenuhi; tidak ada yang mengorbankan pasukan setelah titik berhenti mereka sendiri.