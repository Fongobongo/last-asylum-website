---
title: "Perburuan Pencuri: Kemunculan Bos & Penukaran"
description: "Alur stamina-ke-bos: cara kerja kemunculan Thief Leader yang sebenarnya, teknik nonstop-kill untuk level 30/35, daftar prioritas penukaran komunitas, dan skuad bos yang menumpuk damage paling banyak."
lang: id
updated: "2026-09-03"
videoTopic: thief
calculators: []
...
- Serang pencuri di peta menggunakan stamina. Pembunuhan akan memunculkan bos Thief Leader untuk rally aliansi — **peluang muncul dihitung per pencuri yang dibunuh**, bukan per hari event atau per pemain.
- Bos muncul **pada pembunuhan pertama atau setelah 20 pembunuhan** — peluang terjadi di awal atau setelah rentetan pembunuhan. Satu aliansi melaporkan **selalu 8 atau lebih**; antisipasi variasi dan teruslah membunuh.
- Poin dan hadiah **tidak meningkat di akhir event**. Tidak ada alasan untuk menimbun stamina — **habiskan segera** untuk mendapatkan peluang memunculkan bos besar lebih cepat.

## Level Bos & Progresi Batas Aliansi {#boss-levels}

| Usia Server | Level bos umum |
|---|---|
| Server baru | 10 / 15 / 20 / 25 / 30, jarang 35 |
| Server berkembang | 40 / 65 / 80 / 85 / 90+ |
...
Teknik terverifikasi untuk mendorong level bos ke 30 dan 35:

> Bunuh pencuri satu per satu TANPA membiarkan pasukan Anda kembali ke markas — nonstop, barisan serangan beruntun tanpa waktu tunggu.

Pasukan yang kembali ke markas akan memutus rentetan; pembunuhan beruntun akan memicu peluang kemunculan berulang kali. Rangkai target Anda sehingga barisan berikutnya berangkat tepat saat yang terakhir mendarat, dan bos level tinggi akan muncul jauh lebih sering.

## Daftar Prioritas Penukaran {#exchange}

Toko penukaran adalah hadiah yang sebenarnya, dan urutan konsensus komunitas sudah stabil:
...
2. Speedups
3. Raven chest
4. Epigraphs *saat tersedia*

### Late Game {#late-game}

1. **Herbs** — tidak pernah cukup; akun late-game membeli herbs setiap event.

### Daftar Prioritas Alternatif {#alt-list}

1. Stamina
2. LV3 Raven chest
3. Blue/purple epigraph chests
4. Research/construction speedups
5. Recruitment tickets

Dan satu aturan inventaris: **batas scroll terbawa dari event ke event**. Jika Anda mencapai batas scroll, batas itu akan mengikuti Anda ke event berikutnya — alasan lain mengapa aturan "empat lalu jangan pernah lagi" ada.

## Tips Lapangan (Korpez) {#field-tips}

- **Parkirkan satu skuad di kumpulan pencuri kecil yang padat** dan serang secara beruntun — 10 pembunuhan dalam ~2 menit adalah cara untuk mengisi penghitung kemunculan Anda. Berdiam diri di antara kemunculan lebih baik daripada berkeliling.
