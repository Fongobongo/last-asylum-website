---
title: "Panduan Hero: Skuad, Jalur F2P, Skill"
description: "Skuad F2P kanonik dan linimasa lengkapnya, waktu transisi faksi untuk Warrior, Ranger, dan Warlock, prioritas peningkatan skill, titik batas bintang, dan urutan hero Awakened untuk musim Era of Revival."
lang: id
updated: "2026-09-03"
videoTopic: heroes
...
Hero adalah pengganda *might* terbesar di Last Asylum: Plague — dan hal yang paling mahal untuk diperbaiki jika salah dibangun. Ekonomi *shard* dan *skill badge* menghukum investasi yang tersebar, sehingga komunitas telah menyepakati satu jalur *free-to-play* (F2P) kanonik dan urutan operasi yang ketat di sekitarnya.

Halaman ini mencakup: faksi mana yang harus digunakan pada setiap tahap permainan, skuad F2P kanonik dengan linimasa harian, prioritas *skill* yang diverifikasi melalui analisis *damage-per-badge*, titik batas bintang, dan urutan progres hero *Awakened* untuk musim Era of Revival.
...
Untuk akun baru, ini menyelesaikan dilema umum: bangun inti Warrior yang diberikan secara gratis, meskipun Anda menyukai susunan Ranger. Anda dapat beralih ke Ranger saat ekonomi Anda benar-benar mampu mendanainya.

## Skuad F2P Kanonik {#f2p-squad}
...
Lima hero kanonik bukanlah satu-satunya jalur yang bisa digunakan — berikut adalah pengganti dan varian regional yang diakui.
...
Sejak *epigraph* Raven dirilis, menjalankan satu faksi telah berubah dari bonus yang bagus menjadi strategi dominan. Alasannya: *epigraph* UR hanya memberikan *buff* pada SATU faksi, sehingga skuad yang ditumpuk melipatgandakan segalanya — bonus +20% lima hero dari [tabel faksi](/id/beginners/), ditambah *buff epigraph* UR, ditambah sinergi khusus faksi seperti milik Harper.
...
### Marlena: Tempat Damage Berada {#marlena-skills}

Marlena menyumbang sekitar **85% dari damage skuad Anda sampai Zoya tiba**, dan 50/50 dengannya setelah itu. Dia adalah tempat pertama untuk *badge*.

Namun ada satu jebakan dalam *kit*-nya: jangan pernah memaksimalkan *auto-attack* Marlena ke 30 di awal. Urutan yang diverifikasi adalah:

1. Ultimate terlebih dahulu — selalu.
2. *Skill* aktif kedua.
...
Untuk setiap hero, Korpez memeriksa setiap *skill* dengan level target. Intisarinya:

- **Marlena** — Peerless Blade ke 25 → Wargod's Will ke 25 → Crimson Bloom ke 20 → kembali: Peerless Blade 30, Wargod's Will 30. (8★ pertama untuk membuka Tenacity: +20% ATK/HP/DEF, +10% *cooldown skill*.)
- **Arthur** — bintang maksimal didapat gratis, tetapi *skill*-nya lemah di akhir permainan; hanya sisa, Ult+pasif maksimal ke ~20.
- **Escanor** — perisai berskala dari DEF maksimal (ult) dan HP maksimal (perisai pasif DPS di bawah 50% HP); investasikan pada perlengkapan, lewati *skill* serangannya.
...
1. Hero utama ke 10 bintang.
2. Awakening.
3. Senjata Eksklusif (mencapai 10 Bintang membuka fitur Smelt untuk atribut sekunder bonus).
4. Lord Evolution.
5. Lord Resistance.
6. Era Enhancement — hanya satu *skin* utama.
7. Baru setelah itu: mulai hero kedua melalui tangga yang sama.

Aturan yang mengikat semuanya: **jangan pernah membagi material Awakening**. Melakukan *awakening* satu hero sepenuhnya mengungguli melakukan *awakening* dua hero setengah jalan — lebih baik satu barisan kuat daripada beberapa yang setengah jadi. Konteks khusus Era untuk setiap langkah ada di [panduan Era of Revival](/id/era/).

## Mekanika Awakening & Tiga Hero Awakened Pertama {#awakening-walkthrough}
...
**Marlena (Warrior, hero paket)** — pohon *awakened*-nya menumpuk **Battle Will** (2 tumpukan per warrior sekutu di lapangan, +1% *damage* yang diberikan dan +1% pengurangan *damage* per tumpukan), AW 10 Crimson Bloom miliknya mengenai seluruh tim musuh dan menerapkan *debuff* penghancur pertahanan untuk *damage* susulan, AW 20 membuka mekanika serangan balik Blade Tempest, AW 30 menambahkan +8% ATK/HP/DEF ke warrior sekutu, dan *capstone* menambahkan +5 bilah besar ke siklus serangan normalnya.

**Cynthia (Ranger, F2P dari Lucky Wheel)** — pohonnya menumpuk tanda **Moonlight** (masing-masing 1% *damage* energi, batas sama dengan jumlah Ranger-nya di lapangan) dan AW 20+ memungkinkannya menghabiskan ≥10 tumpukan pada **Moonfall Dance** untuk *damage* energi ledakan. AW 2 meningkatkan *damage skill* 20%, AW 30 memberikan *buff* pada Ranger sekutu +8% ATK/HP/DEF, dan *capstone* ditambah mekanika tumpukan menjadikannya mesin *crit* F2P jarak terjauh.

**Annie (Warlock, F2P)** — *awakening*-nya melipatgandakan tumpukan **burn/scorch**-nya (setiap *tick burn* = 25% dari ATK-nya per detik, 20–30 detik, batas berskala dengan jumlah warlock), AW 20 menambahkan **+250% AoE damage energi terhadap semua target yang terbakar**, dan AW 30 menyebarkan +8% ATK/HP/DEF ke warlock sekutu. Annie adalah *awakening* yang membuat skuad *burn* menjadi opsi akhir permainan yang nyata alih-alih sekadar lelucon.
...
Saat Anda membandingkan akun, *might* adalah jumlah dari lima tumpukan terpisah:
