---
title: "Special events: the nine events of the tab and the day each one arrives"
description: "Special events live in the Special Event tab on the city screen, on the right next to the Value Event button. Unlike the bonus events, which pay for purchases and for log…"
lang: es
updated: "2026-09-19"
type: guide
---
...
>
> Data verified against the game client (v1.0.87, source: [wiki-last-asylum.com](https://wiki-last-asylum.com/en/wiki/special-events)).

Special events live in the Special Event tab on the city screen, on the right next to the Value Event button. Unlike the bonus events, which pay for purchases and for logging in, this tab holds contests and battles: personal, alliance-wide and server-wide. The tab appears at the first Sanctuary levels, and its contents grow with the age of the server, with some events arriving only in the third week.
