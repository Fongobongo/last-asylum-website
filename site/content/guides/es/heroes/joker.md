---
title: "Joker: habilidades, build y subida"
...
<img src="/hero-art/joker.webp" alt="hero art" class="float-right ml-3 mb-3 rounded-xl w-28 sm:w-56" width="220" />

![icon](/hero-icons/joker.webp)

**Nombre oficial:** Joker
>
...
| Unlocks on the server | from server day 14 |
...
Throws a card, dealing 87.15% ATK Physical DMG to the lowest HP target.
...
Throws 2 joker cards, dealing 706.65% ATK Physical DMG to 2 lowest-HP enemies.
...
|---|---|
| no stars | - |
| ★10 | Deals 40% extra damage. |
| ★30 | Extra damage increases to 150%. |
| ★50 | Attack Target +1 |
...
|---|---|
| no stars | - |
| ★15 | Deals 40% extra damage. |
| ★35 | Extra damage increases to 100%. |
| ★45 | Inflicts [Burn] on the target, dealing 400% Attack Damage per second for 3s. |

Value growth by skill level

| Stars | Skill level 1 | Skill level 5 | Skill level 10 | Skill level 40 |
|---|---|---|---|---|
| no stars | 283.5% | 337.5% | 405% | 810% |
...
In combat, increases 8.2% Crit Rate.
...
|---|---|
| no stars | - |
| ★20 | Effect increases by 1.6%. |
| ★45 | Effect increases by 2.4%. |
| ★50 | Effect increases by 4%. |
...
Below, Joker is compared with the other heroes of the same role, of which the game has 16 in total. Skill numbers are taken at the final star threshold and the maximum skill level.
...
Deal Cards · damage multiplier · rank 7 of 16
...
Joker Ace · damage multiplier · rank 1 of 15
...
Skill priority: Joker Ace comes first as the largest number among DPS skills. Hearthunt Red Card is next, striking two targets and returning every 5 seconds while the ultimate recharges. Frenzied Emotion follows, and the auto attack Deal Cards comes last with the support skill: 747% at 50 stars against 5,047.5% from the ultimate.
...
| Condition | Unlocks |
|---|---|
| from the start | Deal Cards |
| hero level 5 | Joker Ace |
| hero level 10 | Hearthunt Red Card |
| hero level 20 | Frenzied Emotion |
| ★5 | Deal Cards: Deals 40% extra damage. |
| ★10 | Joker Ace: Deals 40% extra damage. |
| ★15 | Hearthunt Red Card: Deals 40% extra damage. |
| ★20 | Frenzied Emotion: Effect increases by 1.6%. |
| ★25 | Deal Cards: Extra damage increases to 100%. |
| ★30 | Joker Ace: Extra damage increases to 150%. |
| ★35 | Hearthunt Red Card: Extra damage increases to 100%. |
| hero level 30, ★40 | Tenacity |
| ★45 | Hearthunt Red Card: Inflicts [Burn] on the target, dealing 400% Attack Damage per second for 3s. |
| ★45 | Frenzied Emotion: Effect increases by 2.4%. |
| ★50 | Deal Cards: Extra damage increases to 200%. |
| ★50 | Joker Ace: Attack Target +1 |
| ★50 | Frenzied Emotion: Effect increases by 4%. |
...
Reaching 50 stars takes 975 shards ( Joker Shard). Besides stats, stars unlock stronger versions of the skills, which makes them matter more than levels:
...
40 levels, 2,870 awakening shards in total (Joker Awaken Shard). At max it adds:
