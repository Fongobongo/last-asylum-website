---
title: "Beginner's Guide: Your First Days"
description: "Your first 24 hours in Last Asylum: Plague — the day-one checklist, hero unlock timeline, faction bonuses, the official early lineup, and the five mistakes that ruin new accounts."
lang: en
updated: "2026-09-03"
videoTopic: beginner
...
Work through this list in order. Everything else in the game can wait until these six things are done.
...
## Join an Active Alliance Immediately {#join-alliance}

This is step one for a reason. In an active alliance every construction and research you start gets sped up by allies tapping the help button, which quietly saves hours of timers every single day.

Alliance events are the second income stream of the game. Alliance Duel and similar events hand out hero shards, speedups and resources for participation — but only if the alliance actually plays them.

Membership is also protection. Players looking for easy plunder check who you belong to before attacking; a strong alliance tag makes most of them scroll past you.
...
The Sanctuary is the big central building and the closest thing the game has to a player level. Every other building is capped by it, every upgrade grants EXP, and its level decides what the game lets you touch at all.

- Building levels — nothing in your city can exceed the corresponding Sanctuary gate.
- Hero level cap — your heroes cannot out-level your Sanctuary.
- Troop tiers — higher tiers unlock through the Training Grounds, which are themselves gated by Sanctuary.
- Feature unlocks — workshops, the Tavern, alliance features and event modes all arrive at fixed Sanctuary levels.
...
Hero investment in Last Asylum is brutally expensive. Shards, skill badges, EXP potions and gear materials are all scarce, and a hero that is half-built protects you from nothing.

The community rule is to concentrate every resource on ONE main squad of five heroes — and early on, before you even have five worth using, that means two or three heroes carry your entire account.

Concretely: pick your two or three, dump everything into them, and let everyone else stay at whatever level the game handed them for free. A squad of two invested heroes beats a squad of five evenly-split ones in almost every fight you will actually take.

Which heroes to pick is not a matter of taste — the unlock timeline below and the [Heroes guide](/heroes/) give the canonical path.

## Check Events Before Spending Speedups {#events-speedups}

Speedups, resources and diamonds are not just currencies — they are also event scoring material. A large share of events pay rewards based on how much you consume of something during the event window.

So the habit that separates good accounts from great ones: before you burn through a pile of speedups, open the events tab and check whether an event is running — or starts tomorrow — that rewards speedup usage.

This is what players call the double dip: the same speedup moves your construction forward AND claims event points for it. Spending the pile on a dead Tuesday instead of during the event is paying twice for one result.

## Start Plundering on Day One {#start-plundering}

Plunder is your third income stream after production and events, and it is the one most beginners ignore for weeks. It costs only stamina you were going to waste anyway.

The full mechanics — daily limits, the 100% / 15% / 5% thresholds, the nine-hit rule, the War Supply bonus — live in the [Economy guide](/economy/).

The day-one version is simple: attack the richest target you can beat, never let your stamina sit at the cap, and do not be the player who reaches Sanctuary 20 with dozens of millions in missed plunder behind them. Kept up daily, plundering is worth roughly 27 million resources per day later in the game.
...
## Factions and Counters {#factions-counters}

Heroes belong to three factions — Warrior, Ranger and Warlock — and the game pays you twice for faction discipline: a bonus for stacking one faction, and a counter cycle for fighting.

First, the stacking bonus. The more same-faction heroes you field, the bigger the squad-wide bonus:
...
Second, the counter cycle: Warriors beat Warlocks, Warlocks beat Rangers, Rangers beat Warriors. A Ranger formation takes 20% less damage from Warriors — which is why mid-game Ranger squads farm Warrior-heavy defenders so well.

For lineup building the takeaway is simple: pick one faction lane, stack toward the 5-hero +20% bonus, and check the enemy squad's faction before you attack rather than after.

## Your First Lineup {#early-lineup}

The officially recommended early squad looks like this:
...
The instinct from other city builders is to keep every building at the same level. In Last Asylum that produces a city that is mediocre at everything and gated by nothing. Follow the priority order — Sanctuary first, military and research buildings next, everything else when it blocks you. The full order and the level-by-level roadmap are in the [Buildings guide](/buildings/).

### 2. Judging Heroes Too Early {#mistake-judging-early}

A low-star, level-60 hero feels terrible — weak skills, thin multipliers, no Tenacity. The same hero at high stars is a monster. The classic example is Marlena: she reads as underwhelming early and then becomes roughly 85% of a standard squad's damage once her stars and skills come online. Judge a hero at their breakpoint, not at level 60 with two stars.

### 3. Splitting Resources Across Many Heroes {#mistake-splitting}

Eight half-built heroes lose to two finished ones in every fight that matters, and the shard economy means the resources you wasted on seat-fillers are not coming back. Pick the main five, name the two or three you are building this month, and be ruthless about everything else.

### 4. Letting Stamina Cap {#mistake-stamina}
