---
title: "⚔️ Gear Guide: Craft, Promote, Prioritize"
description: "The community rules of the gear system — what to craft, what to feed, what to skip, and where the materials come from."
lang: en
updated: "2026-09-03"
videoTopic: gear
...
## The cardinal rules {#cardinal-rules}

- **Craft only UR (orange).** Green and blue gear drops for free — never waste materials upgrading it. Dismantle outdated low-tier gear.
- **One squad at a time.** For fast progression, deck out Squad 1 only — swords and gloves for carries, chestplates and boots for tanks.
- **UR heroes before SSR heroes** when distributing gear.
- Quality ladder: **Gold (UR) > Purple (SSR) > Blue (SR) > Green (R) > Gray**.

## Slot priorities {#slot-priorities}
...
- **Weapons: highest UR swords** — "a +0 UR sword outdamages a +30 SSR sword" (attack + crit chance scale skill bases)
- **Gloves: SSR, NOT UR!** SSR gloves at level 30 give **+12.25% damage to monsters**, and SSR glove modifiers apply to FINAL damage — UR gloves boost ATK (weaker) and add useless damage resistance
- **Boots & chest: irrelevant** vs bosses — any level works
