...
- **FAQ**: секция на странице `/tips/` всех языков — 12 вопросов, FAQPage schema для rich snippets
...
- **Промокоды**: copy-to-clipboard, актуальные рабочие коды, официальная страница активации
